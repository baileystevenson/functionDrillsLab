...
function faveColorFinder (color){
  if(color === 'red'){
    ...
    return 'greenis a solid favorite color'
  } else if(color === 'black'){
    return 'so trendy'
  }else{
...
let arrayEvaluator = bigOrSmallArray
...
let splicedArr = theEliminator(contestants,loser)
...
function chocohalic(gold) {
   console.log(gold / 3)
}
let totalFrogs = chocohalic(200)
...
let totalFrogs2 = chocohalic2(200)
